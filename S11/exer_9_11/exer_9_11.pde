/* Rilla's solution for exercise 9.11 in Daniel Shiffman's Nature of Code based
on his Smart Rockets code from example 9.3 but also using FlowField code from Ch. 6

Exercise 9.11
Another way to achieve a similar result is to evolve a flow field. Can you make the genotype 
of a rocket a flow field of PVectors? */
