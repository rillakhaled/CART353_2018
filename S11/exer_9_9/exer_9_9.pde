/* Rilla's solution for exercise 9.9 in Daniel Shiffman's Nature of Code based
...
(of arbitrary length). Jer’s simulation also gives the rockets a finite amount of 
fuel. */
...
void setup() {
  ...
  obstacles.add(new Obstacle(random(width), random(100, height), random(100), 10));
  obstacles.add(new Obstacle(random(width), random(100, height), random(100), 10));
}
